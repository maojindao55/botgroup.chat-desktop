...
echo "  将更新文件   : package.json, src-tauri/tauri.conf.json, src-tauri/Cargo.toml"
echo ""
...
if [[ "$DRY_RUN" == true ]]; then
  echo "[dry-run] 将更新 package.json, src-tauri/tauri.conf.json, src-tauri/Cargo.toml → ${NEW_VERSION}"
