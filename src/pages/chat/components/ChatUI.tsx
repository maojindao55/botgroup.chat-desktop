...
const ChatUI = () => {
  ...
  // 首页建群：写入 custom_groups 后整页跳转到新群（首页用 replaceState 无法切换视图）
  const handleHomeCreateGroup = (newGroup: Group) => {
    try {
  ...
  if (isHomeView) {
    return (
      <HomeView
        ...
        onCreateGroup={handleHomeCreateGroup}
