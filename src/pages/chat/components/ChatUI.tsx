                      ...
                      <div className={message.sender.name === userName ? "text-right max-w-[75%]" : "max-w-[75%]"}>
                        ...
                        <div className={`mt-1 p-3 px-4 shadow-sm chat-message ${
                          ...
                          <ReactMarkdown
                            ...
                            } [&_p]:m-0 [&_pre]:bg-gray-900 [&_pre]:p-2 [&_pre]:m-0 [&_pre]:rounded-lg [&_pre]:text-gray-100 [&_pre]:whitespace-pre-wrap [&_pre]:break-words [&_code]:text-xs [&_ul]:my-2 [&_ol]:my-2 [&_li]:my-1`}
                          >
                            {message.content || '⏳'}
                          </ReactMarkdown>
                        </div>
